...
const ingredients = [
  {
    ...
    description: 'Notre farine de tradition française Label Rouge est moulue sur meule de pierre. Aucun additif, aucun améliorant. Juste le grain, le vent, et le temps.',
  ...
  },
  {
    ...
    description: 'Notre levain est né en 2009. Nourri chaque jour de farine et d\'eau de source, il donne à nos pains leur acidité douce et leur alvéolage caractéristique.',
  ...
  },
  {
    ...
    description: 'Pas de levure industrielle. Le froid ralentit la fermentation, développe les arômes complexes et améliore la digestibilité. La patience est notre principal ingrédient.',
  ...
  },
  {
    ...
    description: 'La sole en pierre emmagasine la chaleur et la restitue de façon homogène. La croûte se forme en quelques secondes, piégeant l\'humidité et les arômes à l\'intérieur.',
    ...
    <section id="ingredients" className="bg-[#2C1810] py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-24">
          {ingredients.map((item, i) => (
            <motion.div
              ...
              className={`grid lg:grid-cols-2 gap-12 lg:gap-20 items-center ${i % 2 === 1 ? 'lg:grid-flow-col-dense' : ''}`}
            >
              {/* Image */}
              <div className={`relative ${i % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                <div className="relative overflow-hidden rounded-2xl aspect-[4/3] group">
                  ...
                  <div className="absolute bottom-5 left-5">
                    <span className="text-6xl font-black text-white/10" style={{ fontFamily: 'Playfair Display, serif' }}>
                      {item.number}
                    </span>
                  </div>
                </div>
                ...
                {i < ingredients.length - 1 && (
                  <div className="hidden lg:block absolute -bottom-12 left-1/2 w-px h-12 bg-gradient-to-b from-[#C19A6B]/30 to-transparent" />
                )}
              </div>
              ...
              <div className={i % 2 === 1 ? 'lg:col-start-1' : ''}>
                <div className="flex items-center gap-3 mb-5">
                  <span className="text-4xl font-black text-[#C19A6B]/20" style={{ fontFamily: 'Playfair Display, serif' }}>
                    {item.number}
                  </span>
                ...
                <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2">
                  ...
                  <span className="text-white/50 text-xs font-mono tracking-wider">{item.detail}</span>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          ...
          <p className="text-white/70 text-xl italic leading-relaxed" style={{ fontFamily: 'Playfair Display, serif' }}>
